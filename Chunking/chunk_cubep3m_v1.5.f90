...
contains
  ...
  subroutine begin_print_screen
      ...
      print*
      print*
      print*, 'Cubep3m simulation details:'
      print*
      print*, 'Nodes = ', nodes_dim
      print*, 'Number of cells per dimension = ', nc
      print*, 'Number of cells per node = ',ncc
      print*
      print*
      print*, 'Spliting simulation into:'
      print*, chunk_x,' in x', chunk_y,' in y', chunk_z,' in z'
      print*
      print*, 'For a total of', no_of_chunks,'chunks'
