...
# 9 "./code/allvars.h" 2
# 92 "./code/allvars.h"
extern double SFH_t[62][20][19];
extern double SFH_dt[62][20][19];
extern int SFH_Nbins[62][20][19];
...
# 528 "./code/allvars.h"
  ...
  float Lum[15][15];
  float YLum[15][15];
  float LumBulge[15][15];
  float YLumBulge[15][15];
  float LumDust[15][15];
  float MassWeightAge[15];
# 603 "./code/allvars.h"
  int sfh_ibin;
  double sfh_age;
  float sfh_dt[19];
...
extern int TotHalos;
extern int TotGalaxies[15];
extern int *TreeNgals[15];
...
extern int ListOutputSnaps[15];
extern float ListOutputRedshifts[15];
...
extern float FilterLambda[15 + 1];
...
extern float MagTableZz[15][4][64][220];
