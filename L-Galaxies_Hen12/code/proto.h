...
void update_from_star_formation(int p, double stars, double dt, int nstep);
...
double collisional_starburst_recipe(double mass_ratio, int merger_centralgal, int centralgal, double time, double deltaT, int nstep);
...
void find_interpolated_obslum(double timenow, double timetarget, double metallicity, double redshift, int *metindex, int *tabindex, int *redindex, double *f1, double *f2,  double *fmet1, double *fmet2, double *fred1, double *fred2); 
