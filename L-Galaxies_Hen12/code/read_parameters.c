...
//Variables used in the MCMC
#ifdef MCMC
  strcpy(tag[nt], "MCMCParameterValues");
  addr[nt] = MCMCParameterValues;
  id[nt++] = STRING;
  ...
  strcpy(tag[nt], "MCMCTreeSampleDir");
  addr[nt] = MCMCTreeSampleDir;
  id[nt++] = STRING;
  ...
  strcpy(tag[nt], "SatelliteRecipe");
  addr[nt] = &SatelliteRecipe;
  id[nt++] = INT;
