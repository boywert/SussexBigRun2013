...
double Chabrier_IMF(double M)
{
	...
	else {printf("Normalization constants for IMF not known. Check upper mass limit (SNII_MAX_MASS)."); exit(1);}
	...
	const double x = 2.3; //Normal Chabrier IMF x = 2.3. Top-heavy IMF x = 2.0
