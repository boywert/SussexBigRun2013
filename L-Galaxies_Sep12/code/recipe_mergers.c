			    ...
			    double Mpstar,double Mpbulge,double Mpgas,double frac)
{
  ...
  if ((Mp+Mc > 0.0 && Gal[merger_centralgal].BulgeSize == 0.0 )||(Mp+Mc == 0.0 && Gal[merger_centralgal].BulgeSize> 0.0)) {
    printf("bulgesize wrong in merger. bulgemass %f, bulgesize %f, Rp %f, Rc %f,Mp %f,Mc %f ,mass ratio %f, halonr %d, merger_centralgal %d\n",Gal[merger_centralgal].BulgeMass, Gal[p].BulgeSize,Rp,Rc,Mp,Mc,mass_ratio,Gal[merger_centralgal].HaloNr,merger_centralgal);
    printf("p: stellarmass %f, bulgemass %f, bulgesize %f, coldgas %f,gasdisk %f,stellardisk %f \n",(Gal[p].DiskMass+Gal[p].BulgeMass),Gal[p].BulgeMass, Gal[p].BulgeSize,Gal[p].ColdGas,Gal[p].GasDiskRadius,Gal[p].StellarDiskRadius);
    printf("central: stellarmass %f, bulgemass %f, bulgesize %f, coldgas %f,gasdisk %f,stellardisk %f \n",(Gal[merger_centralgal].DiskMass+Gal[merger_centralgal].BulgeMass),Gal[merger_centralgal].BulgeMass, Gal[merger_centralgal].BulgeSize,Gal[merger_centralgal].ColdGas,Gal[merger_centralgal].GasDiskRadius,Gal[merger_centralgal].StellarDiskRadius);
    exit(0);
  }
