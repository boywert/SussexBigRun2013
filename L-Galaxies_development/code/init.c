...
//#endif
  ...
  //for(i=0; i<RNUM; i++) radius[i]= pow(1.2,i-3)/1000;  //The radii of the rings. (in unit of Mpc/h)
  int i;
...
void set_units(void)
{
  ...
  k_Boltzmann = GRAVITY/ pow3(UnitLength_in_cm) * UnitMass_in_g * pow2(UnitTime_in_s);
  printf("k= %lf\n",k_Boltzmann);
