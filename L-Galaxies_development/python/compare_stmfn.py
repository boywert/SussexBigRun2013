...
ff = 5
lf = 5
okamoto_model = stellar_mass_fn("/mnt/lustre/scratch/cs390/47Mpc/outputs/okamoto/","SA_z6.00",ff,lf,1.e3,1.e12,50)
...
pylab.savefig('reion_model_5.pdf',bbox_inches='tight')
