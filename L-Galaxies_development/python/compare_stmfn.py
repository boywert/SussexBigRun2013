...
fig = pylab.figure()
ax = fig.add_subplot(111)
ax.plot(cold_okamoto_model[0],cold_okamoto_model[1],'r--')
ax.plot(cold_noreionization_model[0],cold_noreionization_model[1],'b--')
ax.plot(cold_patchyreionization_model[0],cold_patchyreionization_model[1],'m--')
ax.plot(cold_patchyreionization_model_II[0],cold_patchyreionization_model_II[1],'g--')
