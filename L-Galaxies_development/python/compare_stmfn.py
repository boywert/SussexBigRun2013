...
star_patchyreionization_model = stellar_mass_fn("/mnt/lustre/scratch/cs390/47Mpc/outputs/patchy_reionization/",prefix,ff,lf,1.e3,1.e12,50)
...
hot_patchyreionization_model = hotgas_mass_fn("/mnt/lustre/scratch/cs390/47Mpc/outputs/patchy_reionization/",prefix,ff,lf,1.e3,1.e12,50)
...
cold_patchyreionization_model = coldgas_mass_fn("/mnt/lustre/scratch/cs390/47Mpc/outputs/patchy_reionization/",prefix,ff,lf,1.e3,1.e12,50)
