...
star_patchyreionization_model_III = stellar_mass_fn("/mnt/lustre/scratch/cs390/47Mpc/outputs/patchy_reionization_III/",prefix,ff,lf,1.e3,1.e12,50)
...
hot_patchyreionization_model_III = hotgas_mass_fn("/mnt/lustre/scratch/cs390/47Mpc/outputs/patchy_reionization_III/",prefix,ff,lf,1.e3,1.e12,50)
...
bh_patchyreionization_model_III = bh_mass_fn("/mnt/lustre/scratch/cs390/47Mpc/outputs/patchy_reionization_III/",prefix,ff,lf)
...
cold_patchyreionization_model_III = coldgas_mass_fn("/mnt/lustre/scratch/cs390/47Mpc/outputs/patchy_reionization_III/",prefix,ff,lf,1.e3,1.e12,50)
...
ax.plot(star_patchyreionization_model_III[0],star_patchyreionization_model_III[1],'g--',label="Patchy Reionization III")
ax.set_yscale("log")
...
ax.plot(hot_patchyreionization_model_III[0],hot_patchyreionization_model_III[1],'g--',label="Patchy Reionization III")
ax.set_yscale("log")
leg = ax.legend(loc='best', handlelength = 10,ncol=1, fancybox=True, prop={'size':10})
leg.get_frame().set_linewidth(0)
...
ax.plot(cold_patchyreionization_model_III[0],cold_patchyreionization_model_III[1],'g--',label="Patchy Reionization III")
ax.set_yscale("log")
leg = ax.legend(loc='best', handlelength = 10,ncol=1, fancybox=True, prop={'size':10})
leg.get_frame().set_linewidth(0)
ax.set_xlabel(r"$\log(M/M_\odot h)$")
...
ax.plot(bh_patchyreionization_model_III[0],bh_patchyreionization_model_III[1],'g--',label="Patchy Reionization III")
#ax.set_yscale("log")
leg = ax.legend(loc='best', handlelength = 10,ncol=1, fancybox=True, prop={'size':10})
leg.get_frame().set_linewidth(0)
ax.set_xlabel(r"$\log(M/M_\odot h)$")
...
ax.plot(sfr_patchyreionization_model_III[0],sfr_patchyreionization_model_III[1],'g--',label="Patchy Reionization III")
ax.set_yscale("log")
ax.set_xscale("log")
leg = ax.legend(loc='best', handlelength = 10,ncol=1, fancybox=True, prop={'size':10})
leg.get_frame().set_linewidth(0)
