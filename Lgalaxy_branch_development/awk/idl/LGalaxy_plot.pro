...
; plot for each field in the input LGalaxy struct a histogram
 ...
 print, 'plotting  BurstMass'
   plotHist, LGs.BurstMass,'BurstMass','F'
 print, 'plotting  Sfr'
 ...
 print, 'plotting  sfh_time[0]'
   plotHist, LGs.sfh_time(0),'sfh_time[0]','F'
 print, 'plotting  sfh_time[1]'
   plotHist, LGs.sfh_time(1),'sfh_time[1]','F'
 print, 'plotting  sfh_time[2]'
   plotHist, LGs.sfh_time(2),'sfh_time[2]','F'
 print, 'plotting  sfh_dt[0]'
   plotHist, LGs.sfh_dt(0),'sfh_dt[0]','F'
 print, 'plotting  sfh_dt[1]'
   plotHist, LGs.sfh_dt(1),'sfh_dt[1]','F'
 print, 'plotting  sfh_dt[2]'
   plotHist, LGs.sfh_dt(2),'sfh_dt[2]','F'
 ...
 print, 'plotting  sfh_BurstMass[0]'
   plotHist, LGs.sfh_BurstMass(0),'sfh_BurstMass[0]','F'
 print, 'plotting  sfh_BurstMass[1]'
   plotHist, LGs.sfh_BurstMass(1),'sfh_BurstMass[1]','F'
 print, 'plotting  sfh_BurstMass[2]'
   plotHist, LGs.sfh_BurstMass(2),'sfh_BurstMass[2]','F'
end
