...
extern m_halo_wrapper_t sussexbigrun_add_halo_buffer_binary(char *folder, float redshift, int domain, double domain_width, double buffer_width, int position, m_halo_wrapper_t mhalo);
