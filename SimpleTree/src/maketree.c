	  ...
	  if(l%mpi_nodes == mpi_rank)
	    {
	      ...
	      LOG_PRINT("Make links %f->%f",redshiftused[0],redshiftused[1]);
	      halocatA[0] = sussexbigrun_load_halo_catalogue_binary_single_domain(folder,redshiftused[0],l,halocatA[0].snapid);
