...
/* write output file compatible with stereo2 */
//#define STEREO2

/* number density rather than mass density */
//#define NPARTDENS

/* work on simulation data or halo catalogues */
//#define AHF_HALOS

/* only dump high-resolution particles */
//#define MMFOCUS
...
char **argv;
{
  char          indata[MAXSTRING], outdata[MAXSTRING], cdummy[20];
  FILE          *fpin, *fpout;
